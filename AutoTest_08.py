...
def test_float_equality(logfile,nline,l1,l2,atol,rtol):
    ...
    l1s=l1.split(",")
    l2s=l2.split(",")
    nterms1=len(l1s)-1     #as comma is expected at end of a data line
    nterms2=len(l2s)-1
    if (nterms1==nterms2):
...
def run_tests(test_names,atol,rtol):
    ...
    :param atol - absolute tolerance for isclose equality test
    :param rtol - relative tolerance for isclose equality test
    :return - Number of identical files found, number of files examined, List of correct files and list of incorrect files
    """
    correct_f=0
    f_examined=0
    c_list=[]
...
incorrect_list=[]
divider_line='*'*80
a_tests=["a_Test_Circuit_1", "a_Test_Circuit_1BRX", "a_Test_Circuit_1dB", "a_Test_Circuit_1M", "a_Test_Circuit_1nF", "a_Test_Circuit_1nT", "a_Test_Circuit_1Ord", "Ext_a_Test_Circuit_1", "Ext_mdB_a_Test_Circuit_1"]
...
b_tests=["b_CR", "b_RC", "b_Pi_03", "b_Pi_03R", "b_Tee_03", "b_Tee_03R", "Ext_d_LPF_B50"]
...
correct_list.append(clist)
incorrect_list.append(ilist)
e_tests=["e_Ladder_100", "e_Ladder_400", "Ext_e_Ladder_100", "Ext_e_Ladder_400"]
